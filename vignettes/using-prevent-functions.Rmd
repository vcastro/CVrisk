...
The `model = "auto"` parameter intelligently selects the appropriate variant based on which optional predictors (HbA1c, UACR, ZIP code) you provide, maximizing the accuracy of the risk prediction.
...
| Clinical Parameter | PREVENT | ACC/AHA 2013 | Framingham 2008 | Framingham BMI |
|-------------------|---------|--------------|-----------------|----------------|
| **Age range** | 30-79 years | 40-79 years | 30-74 years | 30-74 years |
| **Gender** | Required | Required | Required | Required |
| **Race** | Not used | Required (White/AA/Other) | Not used | Not used |
| **Systolic BP** | Required | Required | Required | Required |
| **BP medication** | Required | Required | Required | Required |
| **Total cholesterol** | Required | Required | Required | Optional |
| **HDL cholesterol** | Required | Required | Required | Optional |
...
| **Statin use** | Required | Not used | Not used | Not used |
| **BMI** | Required | Not used | Optional | Required |
...
| **Risk outcome** | ASCVD | ASCVD | CVD (broader) | CVD (broader) |
...
**Recommendation:** For most clinical use cases, simply use the default `model = "auto"` setting. This allows the algorithm to automatically select the best model variant based on which data you provide, ensuring optimal risk prediction without requiring manual model selection.
