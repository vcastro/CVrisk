#' AHA/ACC PREVENT 2023 10-year ASCVD risk score (BMI-based)
#'
...
ascvd_10y_prevent_bmi <- function(gender = c("male", "female"),
                                  age, bmi, sbp,
  ...
  prevent_10y_bmi_coef <- NULL
  utils::data(prevent_10y_bmi_coef, envir = environment())
  ...
  model_coef <- merge(sex_df, prevent_10y_bmi_coef)
