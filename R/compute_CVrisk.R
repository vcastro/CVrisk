...
#' 
#' library(CVrisk)
#' compute_CVrisk(sample_data, age = "age", race = "race", gender = "gender", bmi = "BMI", sbp = "sbp", 
#'             hdl = "hdl", totchol = "totchol", bp_med = "bp_med", smoker = "smoker", diabetes="diabetes")
#' 
#' @export 
compute_CVrisk <- function (df, scores = c("ascvd_10y_accaha", "ascvd_10y_frs",  "ascvd_10y_frs_simple"), age, gender, race, sbp = NULL, bmi = NULL,
                              hdl = NULL, totchol = NULL,
                              bp_med = NULL, smoker=NULL, diabetes = NULL) {
  

  #scores <- missing(scores)
  
  all_args <- as.list(environment())  
  valid_pred <- c('age', 'gender', 'race', 'sbp', 'bmi', 'hdl', 'totchol', 'bp_med', 'smoker', 'diabetes')
...
#compute_CVrisk(df, age = "age", race = "race", gender = "gender", bmi = "BMI", sbp = "sbp", 
 #                           hdl = "hdl", totchol = "totchol", bp_med = "bp_med", smoker = "smoker", diabetes="diabetes")
