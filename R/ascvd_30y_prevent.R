#' AHA/ACC PREVENT 2023 30-year ASCVD risk score (lipid-based)
#'
...
ascvd_30y_prevent <- function(gender = c("male", "female"),
  ...
  prevent_30y_coef <- NULL
  utils::data(prevent_30y_coef, envir = environment())
  ...
  model_coef <- merge(sex_df, prevent_30y_coef)
